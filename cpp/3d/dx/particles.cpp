...
void cParticleEmitter::Process(float Elapsed)
{
  cParticle *Particle = m_Particles;
...
*/
			...
			Particle->m_Size-=0.01;
			if(Particle->m_Size<0.0f)
			{
				RemoveFromList =true;
			}

			//Particle->m_Color-=D3DCOLOR_RGBA(255,255,0,10);	
...
void cParticleEmitter::HandleEngine(D3DXVECTOR3 *vecPos1,D3DXVECTOR3 *vecPos2, float Elapsed)
{
    Add(5, &D3DXVECTOR3(vecPos1->x, vecPos1->y, vecPos1->z),
        fRnd(0.2f,0.3f), D3DCOLOR_RGBA(0,nRnd(200,250),nRnd(200,250),10), 1000, 
        &D3DXVECTOR3(0.0f, 0.0f, 0.0f));

    Add(5, &D3DXVECTOR3(vecPos2->x, vecPos2->y, vecPos2->z),
        fRnd(0.2f,0.3f), D3DCOLOR_RGBA(0,nRnd(200,250),nRnd(200,250),10), 1000, 
        &D3DXVECTOR3(0.0f, 0.0f, 0.0f));
}
