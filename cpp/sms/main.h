...
#define CLASSNAME			"Отправитель 1.0 Class"		//Arbitrary Names used to identify the window
#define WINDOWNAME			"Отправитель 1.0 Window"
#define DMS_TIP				"Отправитель 1.0"
#define DMS_UIEVENT			"Отправитель 1.0 Event"
#define STR_WND				"Отправитель 1.0"
#define TMR_ID			1

#define RUN_KEY		(TEXT("Software\\Microsoft\\Windows\\CurrentVersion\\Run"))
#define	SOFT_KEY	"Sender"
